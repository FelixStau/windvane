...
typedef struct {
  ...
  char fversion[6] = "V1.01";               // Firmware version
  char license[12] = "CC-BY-NC-ND";         // License type
  ...
  int lchannel = 0;                         // Used LoRa channel [0...7|8|9] 0...7 single channel mode, 8 dynamic channel mode with channel 0...7, 9 dynamic channel mode with channel 0...2
  ...
  int tinterval = 10;                       // LoRa transmit interval x30s, [1...255] (value x 30s = 300s)
