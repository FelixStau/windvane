...
#elif _PIN_OUT==6
// ----------------------------------------------------------------------------
// For Heltec LoRa ESP32 based board for EU32 with 0.9" OLED
//
// SCK  == GPIO5/ PIN5
// SS   == GPIO18/PIN18 CS
// MISO == GPIO19/ PIN19
...
struct pins {
  uint8_t dio0=26;    // GPIO26 / Dio0 used for one frequency and one SF
  uint8_t dio1=34;    // GPIO34 / Used for CAD, may or not be shared with DIO0
  uint8_t dio2=35;    // GPIO35 / Used for frequency hopping, don't care
  uint8_t ss=18;      // GPIO18 / Dx. Select pin connected to GPIO18
  uint8_t rst=14;     // GPIO0 / D3. Reset pin not used 
} pins;
#define SCK 5       // Check
